...
public:
  MyFMatrix(bool _bin = false) : bBinary(_bin) {}
...
ostream &operator<<(ostream &os, const MyFMatrix &dat) { return dat.print(os); }
...
int main(int argc, const char *argv[]) {
  ...
  int retv = read_options(argc, argv, filenames, cov_filename, covnorm_filename,
                          binary);
