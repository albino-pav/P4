...
lpFile = open(path + '/lp16_2_3.txt', 'r')
...
lpccFile = open(path + '/lpcc16_2_3.txt', 'r')
...
mfccFile = open(path + '/mfcc16_2_3.txt', 'r')
...
fig.suptitle('LP, LPCC and MFCC 2nd and 3rd coefficients from 16')
...
lpFile = open(path + '/lp17_2_3.txt', 'r')
lpLines = lpFile.read().splitlines()
c2lp = []
c3lp = []
for x in lpLines:
...
lpccFile = open(path + '/lpcc17_2_3.txt', 'r')
lpccLines = lpccFile.read().splitlines()
c2lpcc = []
c3lpcc = []
for x in lpccLines:
...
mfccFile = open(path + '/mfcc17_2_3.txt', 'r')
mfccLines = mfccFile.read().splitlines()
c2mfcc = []
c3mfcc = []
for x in mfccLines:
...
plt.figure(2)
fig, axs = plt.subplots(3)
fig.suptitle('LP, LPCC and MFCC 2nd and 3rd coefficients from 17')
axs[0].scatter(c2lp, c3lp, s = 1)
axs[0].set_title('LP')
axs[0].tick_params(axis='both', which='both', bottom=False, top=False, labelbottom=False, labelleft=False)  
axs[1].scatter(c2lpcc, c3lpcc, s = 1)
...
lpFile = open(path + '/lp24_2_3.txt', 'r')
lpLines = lpFile.read().splitlines()
c2lp = []
c3lp = []
for x in lpLines:
...
lpccFile = open(path + '/lpcc24_2_3.txt', 'r')
lpccLines = lpccFile.read().splitlines()
c2lpcc = []
c3lpcc = []
for x in lpccLines:
...
mfccFile = open(path + '/mfcc24_2_3.txt', 'r')
mfccLines = mfccFile.read().splitlines()
c2mfcc = []
c3mfcc = []
for x in mfccLines:
...
plt.figure(2)
fig, axs = plt.subplots(3)
fig.suptitle('LP, LPCC and MFCC 2nd and 3rd coefficients from 24')
axs[0].scatter(c2lp, c3lp, s = 1)
axs[0].set_title('LP')
axs[0].tick_params(axis='both', which='both', bottom=False, top=False, labelbottom=False, labelleft=False)  
axs[1].scatter(c2lpcc, c3lpcc, s = 1)
